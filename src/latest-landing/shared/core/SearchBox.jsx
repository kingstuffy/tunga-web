...
class SearchBox extends React.Component {
    ...
    search(query) {
        ...
        if (onChange) {
            ...
            SearchActions.listProjects(
                { search: query, page_size: 3 },
                searchKey
            );
            SearchActions.listInvoices(
                { search: query, page_size: 3 },
                searchKey
            );
        }
                        ...
                        invoices.isLoading ? (
                            ...
                            <div>
                                ...
                                <div className="results-wrapper">
                                    {users.isLoading ? null : users.items
                                          .length ? (
                                        <div className="result-category">
                                            <div className="category-title">
                                                <Icon name="avatar" /> People
                                            </div>
                                    ...
                                    {projects.isLoading ? null : projects.items
                                          .length ? (
                                        <div className="result-category">
                                            <div className="category-title">
                                                <Icon name="projects" />{" "}
                                    ...
                                    {invoices.isLoading ? null : invoices.items
                                          .length ? (
                                        <div className="result-category">
                                            <div className="category-title">
