...
export default class SocialSignIn extends React.Component {
    ...
    render() {
        return (
            <div
                className={`social-auth-options ${this.props.className || ""}`}
            >
                <ul>
                    <li>
                        <a
                        ...
                        >
                            <Icon name="facebook-square" aria-hidden="true" />
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        >
                            <Icon name="github-square" aria-hidden="true" />
                        </a>
                    </li>
                </ul>
            </div>
