            ...
            data: [
                {
                    ...
                    description:
                        "Reinforce your team with remote developers - full time or part time; temporary or permanent. Reinforce your team with remote developers - full time or part time; temporary or permanent. Reinforce your team with remote developers - full time or part time.",
                    imgUrl: Service1,
                    leadTime: "1 - 2 weeks",
                ...
                <div className="">
                    <Row>
                        <Col
                            ...
                            xl="6"
                            xs="12"
                            className="service-bg position-relative"
                        >
                                ...
                                <Row>
                                    <Col>
                                        <Media className="mt-2">
                                            ...
                                            <Media
                                                body
                                                className="pl-2 size-12 text-white"
                                            >
                                                <Media
                                                    heading
                                                    className="size-16 text-white text-uppercase"
                                                >
                                                    Lead Time
                                                </Media>
                                                1-2 weeks
                                ...
                                <section>
                                    ...
                                    <div className="">
                                        {this.state.paginate.transition && (
                                            <Row className="animated fadeInRight">
                                                {this.state.dataPerPage.map(
                                                    (service, i) => (
                                                        <div
                                                            key={i}
                                                            className="p-2"
