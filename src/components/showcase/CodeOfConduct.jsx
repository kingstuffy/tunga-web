...
export default () => {
    let title = "Code of Conduct",
        description = "To promote optimal relations between the Users on our Website, Tunga has formulated a Code of Conduct. This serves as a guide to help all our Users to use the Tunga Website in a way to promotes and ensures trust, safety and respect. And which leads to successful cooperations!";
